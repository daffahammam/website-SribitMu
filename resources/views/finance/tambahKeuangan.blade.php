  ...
  <body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-10">
                <div class="card">
                  <h3 class="text-center mb-2 mt-2">Tambah Data Keuangan</h3>
                    <div class="card-body">
                        <form action="/finance/insertData" method="POST">
                            @csrf
                            <label for="bulan" name="bulan" class="form-label" id="bulan">Bulan</label>
                            <select class="form-select" aria-label="Default select example" name="bulan" id="bulan" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" min="0" name="masuk" class="form-control" id="masuk" aria-describedby="masuk"  required>
                            </div>
                            <div class="mb-3">
                                <label for="keluar" class="form-label">Keluar</label>
                                <input type="number" min="0" name="keluar" class="form-control" id="keluar" aria-describedby="keluar" required>
                            </div>
