...
<html lang="en">
  ...
  <div class="container-fluid">
    <h3 class="text-center mb-4">Data Pengumuman <br> Pimpinan Ranting Muhammadiyah Sribit</h3>
      <div class="row g-3 align-items-center mt-2">
        <div class="col-auto">
          <form action="/announcement/adminAnnouncement" method="GET">
          <input type="search" name="search" id="search" class="form-control" aria-describedby="search" placeholder="Cari Data">
          </form>
        </div>
        <div class="col-auto">
          <a href="/announcement/tambahAnnouncement" class="btn btn-success">Tambah Data</a>
        </div>
      </div>
      <div class="row">
        <div class="table-responsive">
          <table class="table table-hover align-items-center  align-items-center ">
                ...
                <tbody>
                    ...
                    <td>
                      <div class="d-flex">
                        <a href="/announcement/tampilData/{{$announcement->id}}" class="btn btn-info m-1">Edit</a>
                        <a href= "/announcement/deleteData/{{$announcement->id}}" class="btn btn-danger m-1">Hapus</a>
                      </div>
                    </td>
                    </tr>
                    @endforeach
