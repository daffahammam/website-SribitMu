  ...
  <body>
    ...
    @section('editForm')
        ...
        <div class="row justify-content-center">
            <div class="col-10">
                <div class="card">
                  <h3 class="text-center mb-2 mt-2">Tambah Data Kegiatan</h3>
                    <div class="card-body">
                        <form action="/activity/insertData" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="tempat" class="form-control" id="tempat" aria-describedby="tempat" required>
                            </div>
                            <div class="mb-3">
                                <label for="detail" class="form-label">Detail</label>
                                <textarea  name="detail" class="form-control" id="detail" aria-describedby="detail"></textarea>
                            </div>
                            <div class="mb-3">
