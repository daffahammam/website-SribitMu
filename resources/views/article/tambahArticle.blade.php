  ...
  <body>
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-10">
                <div class="card">
                  <h3 class="text-center mb-2 mt-2">Tambah Artikel</h3>
                    <div class="card-body">
                        <form action="/article/insertData" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="text" name="penulis" class="form-control" id="penulis" aria-describedby="penulis" required>
                            </div>
                            <div class="mb-3">
